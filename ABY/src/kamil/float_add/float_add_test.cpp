/**
 ...
 \brief		Adding float problem Test class implementation.
 */
...
int main(int argc, char** argv) {
	...
	test_float_add_circuit(role, address, port, seclvl, 32,
